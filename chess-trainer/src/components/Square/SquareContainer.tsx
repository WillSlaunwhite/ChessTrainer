...
const SquareContainer: React.FC<SquareContainerProps> = ({ square, piece, fen, selectedSquare, highlightedSquares, isTo }) => {
	...
	const handleClick = () => {
		handleSquareClick.handleSquareClick(fen, piece, square, selectedSquare, highlightedSquares);
	};
